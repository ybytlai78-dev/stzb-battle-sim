...
export const OFFLINE_MAIN_SKILLS: Record<string, string> = {
  ...
  // ─── 2026-09-20 批量59：武将 68（田丰·群骑 h692）───
  jinyan_zhijian: '主动战法发动率 +10% / 伤害 +30% 受谋略成长未确认（按基值不缩放；「作用对象为主动战法槽 → 按友军单位施加 2/3 名」「持续到目标行动结束（非下次行动前）」「窗口内发动则下回合 3 名」按用户 2026-09-20 口径 + 推定）',
