...
- **已验证基线**：`npx tsc --noEmit` clean；`npm test` **181 files / 1731 passed**（武将 69 后）；golden 字节一致；
  已实现主战法 **157**、上架池 **89**、《下架武将清单》重生成口径 **待实现 4 / 卡成长率下架 68 / 上架 89**。
